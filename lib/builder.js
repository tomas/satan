...
var check = function(opts) {
  ...
  // Upstart/systemd only: what signal to send when 'service [name] reload' is called.
  ...
  data.up_start_on   = opts.upstart_start_on || 'startup';
  data.up_stop_on    = opts.upstart_stop_on || 'runlevel [016]';
